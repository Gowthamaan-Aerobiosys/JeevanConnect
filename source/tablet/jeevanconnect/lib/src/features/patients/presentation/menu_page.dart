...
class JeevanPatient extends StatefulWidget {
  final dynamic patient;
  const JeevanPatient({super.key, required this.patient});

  @override
  State<JeevanPatient> createState() => _JeevanPatientState();
}

class _JeevanPatientState extends State<JeevanPatient>
                ...
                child: Container(
                  ...
                  child: TabBar(
                    ...
                    tabs: const [
                      ...
                      Tab(child: Text('Records')),
                      //Tab(child: Text('Aero AI')),
                    ],
                  ),
                ),
              )
