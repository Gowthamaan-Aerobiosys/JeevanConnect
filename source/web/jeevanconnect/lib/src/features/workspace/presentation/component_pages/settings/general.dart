...
import '../../../domain/add_contact_form_bloc.dart';
import 'workspace_data_form.dart';
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  WhiteSpace.b6,
                  Text(
                    "You can use the following email addresses for backup or as an additional destination for security-relevant workspace notifications.",
                    style: Theme.of(context)
                        .textTheme
                        .labelSmall!
                  ...
                  ContactTile(
                    isEmail: true,
                    isPrimary: true,
                    title: WorkspaceRepository().currentWorkspace.email,
                  ),
                  WhiteSpace.b32,
                  Center(
                    child: Button(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  WhiteSpace.b6,
                  Text(
                    "View and manage all of the contact numbers associated with your workspace.",
                    style: Theme.of(context)
                        .textTheme
                        .labelSmall!
                        .copyWith(color: AppPalette.greyS8),
                  ...
                  ContactTile(
                    ...
                    isPrimary: true,
                    title:
                        "+91-${WorkspaceRepository().currentWorkspace.contact}",
                  ),
                  WhiteSpace.b32,
                  Center(
                    child: Button(
...
class WorkspaceFormCard extends StatefulWidget {
  const WorkspaceFormCard({super.key});

  @override
  State<WorkspaceFormCard> createState() => _WorkspaceFormCardState();
}

class _WorkspaceFormCardState extends State<WorkspaceFormCard> {
  bool isEditOn = false;
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    WhiteSpace.b6,
                    Text(
                      WorkspaceRepository().currentWorkspace.email,
                      style: Theme.of(context)
                          .textTheme
                          .labelMedium!
                          .copyWith(color: AppPalette.black),
                    ...
                    WhiteSpace.b6,
                    Text(
                      'Workspace ID: ${WorkspaceRepository().currentWorkspace.workspaceId}',
                      style: Theme.of(context)
                          .textTheme
                          .labelMedium!
                          .copyWith(color: AppPalette.black),
