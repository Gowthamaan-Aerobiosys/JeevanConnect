...
class VentilationSessionStatistics extends StatefulWidget {
  const VentilationSessionStatistics({
    super.key,
    required this.year,
    Color? line1Color,
    Color? line2Color,
    Color? betweenColor,
  })  : line1Color = line1Color ?? AppPalette.green,
  ...
  @override
  State<VentilationSessionStatistics> createState() =>
      _VentilationSessionStatisticsState();
}

class _VentilationSessionStatisticsState
    extends State<VentilationSessionStatistics> {
  Map sessionCount = {};
  ...
  _getSessionData() async {
    sessionCount =
        await WorkspaceRepository().getWorkspaceSessionAnalytics(widget.year);
    isLoading = false;
            ...
            LineChartData(
              lineTouchData: LineTouchData(
                  ...
                  touchTooltipData: LineTouchTooltipData(
                    getTooltipColor: (touchedSpot) => AppPalette.bgColorLight,
                  )),
              lineBarsData: [
                LineChartBarData(
                  spots: getSpots(),
